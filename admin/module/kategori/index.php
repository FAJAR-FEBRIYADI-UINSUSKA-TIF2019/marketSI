              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<form method="POST" action="fungsi/edit/edit.php?kategori=edit">
							<table>
								<tr>
									<td style="width:15pc;"><input type="text" class="form-control" value="<?= $edit['nama_kategori'];?>" required name="kategori" placeholder="Input Baru Kategori Barang">
						...
						<form method="POST" action="fungsi/tambah/tambah.php?kategori=tambah">
							<table>
								<tr>
									<td style="width:15pc;"><input type="text" class="form-control" required name="kategori" placeholder="Input Baru Kategori Barang"></td>
									<td style="padding-left:10px;"><button id="tombol-simpan" class="btn btn-success"></i> Tambah Data</button></td>
								</tr>
							</table>
						</form>
						<?php }?>
