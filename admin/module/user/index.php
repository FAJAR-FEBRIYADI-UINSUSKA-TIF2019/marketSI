                  ...
                  <div class="col-lg-12 main-chart">
						...
						<?php }?>
									...
									<div class="panel-footer">
										<form method="POST" action="fungsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
											...
											<span class="pull-right">
												<button type="submit"  class="btn btn-success btn-sm" value="Tambah">Ubah Photo</i></button>
											</span>
										</form>
										<br/>
										<br/>
							...
							<div class="col-sm-5">
								<div class="panel panel-primary">
									<div class="panel-heading">
										<h4><i class="fa fa-user"></i>  Atur User </h4>
									</div>
									<div class="panel-body">
											...
											<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?profil=edit" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="form-actions pull-right">
														<input type="hidden" name="id" value="<?php echo $hasil['id_member']; ?>">
														<button class="btn btn-success" name="btn" value="Tambah" style="border-radius:0px;">Update</button>
													</div>
												</fieldset>
											</form>
										</div>
							...
							<div class="col-sm-4">
								<div class="panel panel-primary">
									<div class="panel-heading">
										<h4><i class="fa fa-lock"></i>  Change Pass</h4>
									</div>
									<div class="panel-body">
										<div class="box-content">
											 <form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?pass=ganti-pas">
												...
												<fieldset>
													...
													<div class="pull-right">															
														...
														<button type="submit" class="btn btn-success" value="Tambah" style="border-radius:0px;" name="proses">Update</button>
													</div>
												</fieldset>
											</form>
										</div>
